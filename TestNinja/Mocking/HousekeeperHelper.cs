namespace TestNinja.Mocking
{
    public class HousekeeperService
    {
        ...
        public HousekeeperService(IStatementGenerator statementGenerator, IEmailSender emailSender, IUnitOfWork unitOfWork, IXtraMessageBox xtraMessageBox)
        {
        ...
        public bool SendStatementEmails(DateTime statementDate)
        {
            ...
            foreach (var housekeeper in housekeepers)
            {
                ...
                try
                {
                    // _housekeepingRepository.EmailFile(emailAddress, emailBody, statementFilename,
